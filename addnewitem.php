...
/*mysql_query("create table Items(ItemName varchar(30), ItemPrice int(5))");*/
...
/*echo "<script type='text/javascript'>alert('Enter Item Name and Item Price')
...
$query=mysql_query("select*from product where ItemName='".$pname."' ");
